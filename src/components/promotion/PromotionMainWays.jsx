...
const PromotionMainWays = () => {
    const items = [
        new Item('Демографический подход', "line-md:map-marker-alt-loop"), new Item('Контроль процессов', 'line-md:speed-loop'),
...
export default PromotionMainWays;