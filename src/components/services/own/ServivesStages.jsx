...
const ServicesStages = async () => {
  const stages = [
    "Консультация",
    "Составление план-проекта",
    "Подписание договора на разработку проекта",
    "Составление дизайна",
    "Утверждение дизайна",
    "Frontend-разработка",
    "Утверждение frontend-разработки",
    "Backend-разработка",
    "Утверждение Backend-разработки",
    "Базовая настройка СЕО",
    "Деплой проекта на ваш домен",
    "Подписание закрывающего договора",
  ];
  return (
