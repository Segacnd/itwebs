...
const VacanciesAdvantages = () => {
  ...
  const advantages = [
    new Advantage("карьерный рост", "charm:rocket"),
    new Advantage("современные технологии", "ri:computer-line"),
    new Advantage("свобода идей", "cuida:lamp-on-outline"),
    new Advantage("командная работа", "ri:team-line"),
    new Advantage("конкурентная зарплата", "streamline-ultimate:cash-briefcase"),
  ];
  return (
    <div className={globalStyles.block + " " + styles.advatangesBlock}>
      <motion.h3
        ...
        className={styles.advantagesHeading}
      >
