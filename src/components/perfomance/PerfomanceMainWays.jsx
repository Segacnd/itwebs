...
const PerfomanceMainWays = () => {
  const items = [
    new Item("Индивидуальный дизайн", "svg-spinners:blocks-shuffle-3"),
    new Item("Чистый код и скорость", "famicons:code"),
...
export default PerfomanceMainWays;
