  ...
  return (
    {
      ...
      description: 'Хотите, чтобы ваш бизнес заметили? Мы здесь, чтобы помочь! Откройте для себя наши услуги маркетинга и узнайте, как мы можем сделать ваш бренд ярче, а продажи – выше',
      authors: [{ name: 'ITWEBS' }],
      openGraph: {
        title: 'Услуги интернет маркетинга на территории Беларуси',
        description: 'Хотите, чтобы ваш бизнес заметили? Мы здесь, чтобы помочь! Откройте для себя наши услуги маркетинга и узнайте, как мы можем сделать ваш бренд ярче, а продажи – выше',
