...
export const generateMetadata = async () => {
  return {
    ...
    description:
      "SMM продвижение - комплексный подход к развитию вашего бизнеса в социальных сетях. Мы предлагаем разработку стратегии, создание контента, таргетированную рекламу и аналитику результатов",
    authors: [{ name: "ITWEBS" }],
    openGraph: {
      title:
        "SMM | эффективное продвижение бизнеса в социальных сетях | ITWEBS",
      description:
        "SMM продвижение - комплексный подход к развитию вашего бизнеса в социальных сетях. Мы предлагаем разработку стратегии, создание контента, таргетированную рекламу и аналитику результатов",
