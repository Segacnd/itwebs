    ...
    return (
        {
            ...
            description: 'Мы специализируемся на привлечении именно той аудитории, которая с наибольшей вероятностью станет вашими покупателями. Используя проверенные стратегии и современные инструменты',
            authors: [{ name: 'ITWEBS' }],
            openGraph: {
                title: 'Привлечение трафика: больше посетителей, клиентов и продаж',
                description: 'Мы специализируемся на привлечении именно той аудитории, которая с наибольшей вероятностью станет вашими покупателями. Используя проверенные стратегии и современные инструменты',
