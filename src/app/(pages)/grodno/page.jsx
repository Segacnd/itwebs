...
export const generateMetadata = async () => {
  return (
    {
      title: 'Разработка веб-приложений под ключ Гродно и обл.',
      description: 'Разработка сайтов веб-приложений различной сложности в Гродно и области. Landing-page, корпоративный сайт, интернет-магазин, SEO-продвижение',
      authors: [{ name: 'ITWEBS' }],
      openGraph: {
        title: 'Разработка сайтов под ключ Гродно и обл. | ITWEBS',
        description: 'Разработка сайтов веб-приложений различной сложности в Гродно и области. Landing-page, корпоративный сайт, интернет-магазин, SEO-продвижение',
        url: `https://itwebs.by/grodno`,
        ...
        images: [
          {
            ...
            width: 1200,
            height: 630,
            alt: 'Разработка сайтов под ключ Гродно и обл.| ITWEBS',
          },
        ],
      },
    }
