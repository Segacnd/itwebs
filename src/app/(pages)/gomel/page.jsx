...
import GomelFirstBlock from '@/components/cities/gomel/GomelFirstBlock';

export const generateMetadata = async () => {
  return (
    {
      title: 'Разработка веб-приложений под ключ в Гомеле и обл.',
      description: 'Разработка сайтов веб-приложений различной сложности в Гомеле и области. Landing-page, корпоративный сайт, интернет-магазин, SEO-продвижение',
      authors: [{ name: 'ITWEBS' }],
      openGraph: {
        title: 'Разработка сайтов под ключ в Гомеле и обл. | ITWEBS',
        description: 'Разработка сайтов веб-приложений различной сложности в Гомеле и области. Landing-page, корпоративный сайт, интернет-магазин, SEO-продвижение',
        url: `https://itwebs.by/gomel`,
        ...
        images: [
          {
            ...
            width: 1200,
            height: 630,
            alt: 'Разработка сайтов под ключ в Гомеле и обл.| ITWEBS',
          },
        ],
      },
    }
